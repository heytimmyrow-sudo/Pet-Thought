...
const sceneKeywords = {
  ...
  floor: /floor|ground-level/i,
  window: /window|view|lookout/i,
  crate: /crate|cage|kennel|den/i,
  leash: /leash|walk|adventure/i,
  bowl: /bowl|snack|refill/i,
  blanket: /blanket|cozy|soft|snuggle/i,
  rug: /rug|carpet|floor|paw/i,
